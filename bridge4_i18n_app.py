...
APP: dict[str, dict[str, str]] = {
    "ko": {
        ...
        'ocr_run': '그림에서 글자를 읽는 중…',
        'ocr_ok': '글자 {n}자를 읽었습니다. 아래 본문에 넣었습니다.',
        'ocr_none': '그림에서 글자를 찾지 못했습니다. 사진이나 로고만 있는 것 같습니다.',
        'ocr_fail': '그림을 읽지 못했습니다.',
        'ocr_key': '그림 속 글자를 읽으려면 위에 OpenAI 키를 넣어 주세요.',
        'ocr_show': '읽어낸 글자 보기',
        'ocr_warn': '그림에서 읽은 글자입니다. 글자가 깨져 잘못 읽힐 수 있으니 금액과 시간은 공고 원문과 함께 확인하세요.',
        'cond_only': '이 공고는 상세요강이 이미지로 올라와 본문 글자가 없습니다. 대신 채용 사이트에 입력된 아래 근로조건을 근거로 진단합니다.',
        'cond_box': '공고가 밝힌 근로조건',
    ...
    "en": {
        ...
        'ocr_run': 'Reading text from the images…',
        'ocr_ok': 'Read {n} characters. Added to the posting text below.',
        'ocr_none': 'No text found in the images — they look like photos or logos only.',
        'ocr_fail': 'Could not read the images.',
        'ocr_key': 'Enter your OpenAI key above to read text from images.',
        'ocr_show': 'Show the text that was read',
        'ocr_warn': 'This text was read from an image. Characters can be misread, so check amounts and times against the original posting.',
        ...
        'cond_box': 'Working conditions stated in the posting',
    ...
    "zh": {
        ...
        'ocr_btn': '读取图片文字（{n}张）',
        'ocr_run': '正在读取图片中的文字…',
        'ocr_ok': '已读取 {n} 个字，并填入下方公告正文。',
        'ocr_none': '图片中没有找到文字，看起来只有照片或标志。',
        'ocr_fail': '无法读取图片。',
        'ocr_key': '要读取图片文字，请在上方填入 OpenAI 密钥。',
        'ocr_show': '查看读取到的文字',
        'ocr_warn': '这是从图片读取的文字。文字可能被误读，请把金额和时间与公告原文对照确认。',
    ...
    "vi": {
        ...
        'ocr_run': 'Đang đọc chữ trong hình…',
        'ocr_ok': 'Đã đọc {n} ký tự và điền vào nội dung tin bên dưới.',
        'ocr_none': 'Không tìm thấy chữ trong hình — có vẻ chỉ có ảnh hoặc logo.',
        'ocr_fail': 'Không đọc được hình ảnh.',
        'ocr_key': 'Hãy nhập khóa OpenAI ở trên để đọc chữ trong hình.',
        'ocr_show': 'Xem chữ đã đọc được',
        'ocr_warn': 'Đây là chữ đọc từ hình ảnh. Chữ có thể bị đọc sai, hãy đối chiếu số tiền và giờ làm với tin gốc.',
        ...
        'cond_box': 'Điều kiện làm việc tin đã nêu',
    ...
    "ja": {
        ...
        'ocr_run': '画像から文字を読み取っています…',
        'ocr_ok': '{n}文字を読み取り、下の本文に入れました。',
        'ocr_none': '画像に文字が見つかりませんでした。写真やロゴだけのようです。',
        'ocr_fail': '画像を読み取れませんでした。',
        'ocr_key': '画像の文字を読むには、上に OpenAI キーを入力してください。',
        'ocr_show': '読み取った文字を見る',
        'ocr_warn': '画像から読み取った文字です。誤読の可能性があるため、金額と時間は求人原文と併せて確認してください。',
    ...
    "es": {
        ...
        'ocr_run': 'Leyendo el texto de las imágenes…',
        'ocr_ok': 'Se leyeron {n} caracteres y se añadieron al texto de abajo.',
        'ocr_none': 'No se encontró texto en las imágenes; parecen solo fotos o logos.',
        'ocr_fail': 'No se pudieron leer las imágenes.',
        'ocr_key': 'Introduce tu clave de OpenAI arriba para leer el texto de las imágenes.',
        'ocr_show': 'Ver el texto leído',
        'ocr_warn': 'Este texto se leyó de una imagen. Puede haber errores de lectura, así que compara importes y horarios con la oferta original.',
        ...
        'cond_box': 'Condiciones laborales indicadas',
